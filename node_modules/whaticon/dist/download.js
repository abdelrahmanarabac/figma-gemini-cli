...
function getVariantDir(variant) {
    return join(CACHE_DIR, variant);
}
function getIndexPaths(variant) {
...
export function isIndexDownloaded(variant) {
...
async function getLatestIndexTag() {
...
export async function downloadIndex(variant, onProgress) {
...
export function loadCachedIndex(variant) {
...
export async function ensureIndex(variant, onProgress) {
