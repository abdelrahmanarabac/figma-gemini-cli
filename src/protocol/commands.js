...
const COMMANDS = {
    ...
    'style.list': { params: [] },
    'style.delete_all': { params: [] },
    'style.create_text': { params: ['name', 'fontSize'], optional: ['fontWeight', 'fontFamily', 'lineHeight', 'letterSpacing'] },
    'style.create_text_styles': { params: ['styles'] },
    ...
    'tokens.create_system': { params: ['system'] },
    'eval': { params: ['code'] },
